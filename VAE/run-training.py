...
import sys, os
sys.path.append('../')
from models import FC_Encoder, FC_Decoder, CNN_Encoder, CNN_Decoder
...
if __name__ == "__main__":
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        with torch.no_grad():
            ...
            images_per_row = 20
            interpolations = get_interpolations(vae.model, device, images, images_per_row)
            ...
            save_image(interpolations.view(-1, 1, 28, 28),
                    'results/interpolations' + str(epoch) + '.png',  nrow=images_per_row)
